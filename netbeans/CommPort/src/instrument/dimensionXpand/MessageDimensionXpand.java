...
import static instrument.dimensionXpand.TypeReceivedMessage.*;
import java.util.Arrays;

public class MessageDimensionXpand extends instrument.Message {
    ...
    public MessageDimensionXpand(byte[] rawMessage) {
        ...
        switch (super.type) {
            case "P":
                typeReceivedMessage = POLL_MESSAGE;
                break;
            case "M":
                typeReceivedMessage = REQUUEST_ACCEPTANCE_MESSAGE;
                break;
            case "I":
                typeReceivedMessage = QUERY_MESSAGE;
                break;
            case "R":
                typeReceivedMessage = RESULT_MESSAGE;
                break;
            case "C":
                typeReceivedMessage = CALIBRATION_RESULT_MESSAGE;
                break;
