        ...
        try {
            ...
            if (inputValueMainRun == ENQ) {
                ...
                if (inputValueMainRun == STX) {
                    ...
                    if(type == RESULT_FROM_INSTRUMENT) {
        ...
        try {
            ...
            for (Record record : listRecords) {
                if (record.getTypeRecord() == TypeRecord.ORDER) {
                    ...
                    int parameterId = 0;
                    entity.Test test = model.getTestByTestCode(result.getTestCode(), this.instrument.getId());
                    if (test != null) {
