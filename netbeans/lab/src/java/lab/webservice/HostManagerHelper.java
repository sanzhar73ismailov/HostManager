...
import instrument.ModeSystemWorking;
...
public class HostManagerHelper {
    ...
    public String getResutResponseXML(List<Result> listResults, Message message) throws LisParseException {
        ...
        try {
            ...
            for (int i = 0; i < listResults.size(); i++) {
                ...
                String unitsVal = util.Util.getAsciiPrintable(resultObj.getUnits());
    ...
    private static String getUniqueTests(String[] strArray) {
        ...
        if (util.Util.isAllDigits(strArray)) {
            strArray = util.Util.getSortedAsDigits(strArray);
        } else {
