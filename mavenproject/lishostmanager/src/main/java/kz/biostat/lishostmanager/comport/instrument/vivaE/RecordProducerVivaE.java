...
import kz.biostat.lishostmanager.comport.instrument.immulite2000.RecordProducerImmulite2000;
    ...
    public Record createPatientRecord(WorkOrder wo) throws InstrumentException {
        try {
            ...
            if (wo.getPatientNumber() != null) {
                ...
                patId = RecordProducerImmulite2000.replaceAllSpecialCharacters(patId);
            }
            if (wo.getPatientName() != null) {
                patName = RecordProducerImmulite2000.replaceAllSpecialCharacters(wo.getPatientName());
